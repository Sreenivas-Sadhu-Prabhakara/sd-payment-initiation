package com.bank.bian.paymentinitiation.model;
...
/**
 * The BIAN control record for this service domain: "Payment Instruction Procedure".
 *
 ...
 * to its asset type (Payment Instruction). Phase 1 keeps a generic, shallow shape;
...
public class ControlRecord {
    ...
    private final String controlRecordType = "Payment Instruction Procedure";
